...
EGLBoolean esDestroyWindow(ESContext *esContext)
{
	return EGL_TRUE;
}
...
EGLBoolean WinCreate(ESContext *esContext, const char *title)
{
  ...
  maliFBNativeWindow.width = esContext->width;
  maliFBNativeWindow.height = esContext->height;
  esContext->hWnd = &maliFBNativeWindow;
...
EGLBoolean esDestroyDestroy(ESContext *esContext)
{
	return EGL_TRUE;
}
